...
final class PasswordChangePopupViewController: PopupViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        addChild(passwordChangeVC)
        passwordChangeVC.didMove(toParent: self)
        containerView.addSubview(passwordChangeVC.view)
        containerView.addConstraintsWithFormat(format: "H:|[v0]|", views: passwordChangeVC.view)
    ...
    func addNavigationBar() {
        ...
        containerView.addConstraintsWithFormat(format: "V:[v0][v1]|", views: navigationBar, passwordChangeVC.view)
    }
    
    @objc func saveButtonAction() {
        passwordChangeVC.saveButtonAction()
    }
